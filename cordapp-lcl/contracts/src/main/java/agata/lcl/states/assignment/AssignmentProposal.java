...
public class AssignmentProposal extends Proposal<AssignmentState> {
    ...
    public AssignmentProposal(Party proposer, Party proposee, CommandData command, AssignmentState proposedState) {
        super(proposer, proposee, command, proposedState);
    }

    @ConstructorForDeserialization
    public AssignmentProposal(Party proposer, Party proposee, CommandData command, AssignmentState proposedState, UniqueIdentifier linearId) {
